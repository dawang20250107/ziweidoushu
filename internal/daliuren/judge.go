...
var keTypeMeaning = map[string]string{
	"贼克": "贼克课——事有克战、吉凶分明,当机立断、以刚制之则决",
	"比用": "比用课——事有比助、择近类而用,取和同、宜循类相求",
	"涉害": "涉害课——事经涉历、深浅有别,过程曲折、以深浅归着定成败",
	"遥克": "遥克课——事在远应、隔位相干,外来之扰、影响间接而不切身",
	"昴星": "昴星课——事出意外、虎视之象,宜静守、防惊扰突变",
	"伏吟": "伏吟课——伏而不动、事主静止,忧疑滞塞、宜守不宜进",
	"返吟": "返吟课——返复不定、动荡不安,事多反复、宜防变卦中途生枝",
}
