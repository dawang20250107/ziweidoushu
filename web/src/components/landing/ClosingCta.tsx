...
export function ClosingCta() {
  return (
    <section className="focus-row mx-auto max-w-6xl px-4 pb-24 md:pb-32">
      <div
        className="reveal relative overflow-hidden rounded-[10px] bg-bg-raised px-8 py-14 md:px-14 md:py-20"
