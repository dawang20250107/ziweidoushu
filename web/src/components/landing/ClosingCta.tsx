    ...
    <section className="mx-auto max-w-6xl px-4 pb-24 md:pb-32">
      ...
      >
        ...
        <div className="relative flex flex-col items-start gap-8 md:flex-row md:items-center md:justify-between md:gap-12">
          ...
          <Link
            href="/chart"
            className="glow-gold inline-flex min-h-[44px] shrink-0 items-center rounded-[6px] bg-gold px-8 py-3 text-[15px] font-medium text-[#161206] transition-colors hover:bg-gold-bright"
          >
            开始排盘
          </Link>
        </div>
